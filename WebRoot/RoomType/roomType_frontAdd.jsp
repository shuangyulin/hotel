			...
			<div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="roomTypeAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="roomType_price" class="col-md-2 text-right">价格(每天):</label>
						  	 <div class="col-md-8">
							    <input type="text" id="roomType_price" name="roomType.price" class="form-control" placeholder="请输入价格(每天)">
							 </div>
						  </div>
				          <div class="form-group">
